...
<link href="/resources/shop/common/_bootstrap/bootstrap-5.1.3-dist/css/bootstrap.min.css" rel="stylesheet">
...
<body>
	<form>
		<header style="float: left; width: 55%;" class="d-none d-md-block d-lg-block d-xl-block d-xxl-block">
			<input type="image" src="../../../images/logo.png" style="width: 80px; float: left;">
		...
		<section style="float: right; width: 30%;" class="d-none d-md-block d-lg-block d-xl-block d-xxl-block">
			<input type="image" src="../../../images/user.png" style="width: 40px; margin: 20px; float: left;">
		...
		<div class="container-fluid" style="clear: both;background-color: purple;" >
			<input type="image" src="../../../images/logo.png" style="width: 8%; float: left;" class="d-md-none">
			...
			<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  				...
  				<div class="offcanvas-body">
  					<ul>
						...
						<li><a class="nav-link" href="#">시스템 관리</a></li>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-12 col-md-6">
					...
					<input type="text" class="form-control" id="firname" value="한" disabled>
				</div>
				<div class="col-12 col-md-6">
					<label for="firnameen" class="form-label">성(영문)</label> 
					<input type="text" class="form-control" id="firnameen" value="Han" disabled>
				</div>
			</div>
			<div class="row">
				<div class="col-12 col-md-6">
			...
			<div class="row">
				<div class="col-12 col-md-6">
					...
					<input type="text" class="form-control" id="changer" value="한동훈" disabled>
				</div>
				<div class="col-12 col-md-6">
					<label for="changeday" class="form-label">최종수정일</label> 
					<input type="text" class="form-control" id="changeday" value="2022-01-01" disabled>
				</div>
				<div class="col-12 col-md-6">
					<label for="firstchanger" class="form-label">최초등록자</label> 
					<input type="text" class="form-control" id="firstchanger" value="2022-01-01"disabled>
				</div>
				<div class="col-12 col-md-6">
					<label for="firstchangeday" class="form-label">최초등록일</label> 
					<input type="text" class="form-control" id="fisrtchangeday" value="한동훈"disabled>
				</div>
			</div>
		</div>
	</form>
	
<script src="/resources/shop/common/_bootstrap/bootstrap-5.1.3-dist/js/bootstrap.bundle.min.js"> </script>
